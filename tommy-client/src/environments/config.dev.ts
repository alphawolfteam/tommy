...
export const config = {
    ...
    GET_PLACES: () => `/api/caisd-rest/loc?WC=delete_flag%3D0%20and%20z_moked%20is%20not%20null&size=300`,
    ...
    GET_PLACE: (organizationUUID: string) => `/api/caisd-rest/org?WC=id%3D${organizationUUID}`,
